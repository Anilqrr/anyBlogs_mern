...
export const AllBlogGet = createAsyncThunk(
     ...
     async () => {
          ...
          const response = await axios.get('https://any-blogs.vercel.app/api/all/blogs').then((response) => {
...
export const FullBlogGet = createAsyncThunk(
     'blog/getBlogs',
     async (id) => {
          const response = await axios.post(`https://any-blogs.vercel.app/api/get/blog/${id}`, {}).then((response) => {
...
export const OtherUserBlogGet = createAsyncThunk(
     '/other/user/getBlogs',
     async (id) => {
          const response = await axios.post(`https://any-blogs.vercel.app/api/other/user/get/blog/${id}`, {}).then((response) => {
...
export const UserGetBlogs = createAsyncThunk(
     'user/getBlogs',
     async () => {
          const response = await axios.post('https://any-blogs.vercel.app/api/user/getblogs', {}, {
               headers: {
...
export const UserBlogAdd = createAsyncThunk(
     ...
     async (blog) => {
          ...
          const response = await axios.post('https://any-blogs.vercel.app/api/user/add/blog', {
...
export const UserBlogDelete = createAsyncThunk(
     'user/blog/delete',
     async (id) => {
          const response = await axios.delete(`https://any-blogs.vercel.app/api/user/delete/blog/${id}
`, {
               headers: {
                    'auth-token': localStorage.getItem('auth-token')
               }
...
export const UserBlogEditGet = createAsyncThunk(
     'user/blog/get/edit',
     async (id) => {
          const response = await axios.post(`https://any-blogs.vercel.app/api/user/edit/blogeditget/${id}
`, {}, {
               headers: {
                    'auth-token': localStorage.getItem('auth-token')
               }
...
export const UserBlogEdit = createAsyncThunk(
     ...
     async (blog) => {
          ...
          const response = await axios.patch(`https://any-blogs.vercel.app/api/user/update/blog/${_id}
...
export const CategoryWiseGetData = createAsyncThunk(
     ...
     async (name) => {
          ...
          const response = await axios.get(`https://any-blogs.vercel.app/api/category/wise/getdata/${name}
`).then((response) => {
