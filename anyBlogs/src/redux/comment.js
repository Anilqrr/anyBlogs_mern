...
export const BlogCommentGets = createAsyncThunk(
    ...
    async (bid) => {
        const { id } = bid;
        const response = await axios.get(`http://localhost:5000/api/blog/comments/${id}`).then((response) => {
...
export const UserBlogCommentSend = createAsyncThunk(
    ...
    async (comments) => {
        ...
        const response = await axios.post(`http://localhost:5000/api/blog/user/comments/${id}`, {
            comment
        }, {
            headers: {
...
export const UserBlogsCommentedGets = createAsyncThunk(
    ...
    async () => {
        ...
        const response = await axios.post(`http://localhost:5000/api/blog/user/comments/get`, {}, {
            headers: {
                "auth-token": localStorage.getItem("auth-token")
            }
        }).then((response) => {
...
export const UserBlogCommentEditGet = createAsyncThunk(
    ...
    async (id) => {
        ...
        const response = await axios.post(`http://localhost:5000/api/blog/user/comments/edit/get/${id}`, {}, {
            headers: {
                "auth-token": localStorage.getItem("auth-token")
            }
        }).then((response) => {
...
export const UserBlogCommentEdit = createAsyncThunk(
    ...
    async (comments) => {
        ...
        const response = await axios.patch(`http://localhost:5000/api/blog/user/comments/edit/${_id}`, { comment }, {
            headers: {
                "auth-token": localStorage.getItem("auth-token")
            }
        }).then((response) => {
...
export const UserBlogCommentDelete = createAsyncThunk(
    ...
    async (id) => {
        const _id = id;
        const response = await axios.delete(`http://localhost:5000/api/blog/user/comments/delete/${_id}`, {
            headers: {
                "auth-token": localStorage.getItem("auth-token")
            }
        }).then((response) => {
