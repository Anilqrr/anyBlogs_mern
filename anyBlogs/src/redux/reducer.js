...
export const SignupUser = createAsyncThunk(
  ...
  async (user) => {
    ...
    const response = await axios.post('https://any-blogs.vercel.app/api/signup', { username, email, password, gender, birthdate, country })
      .then((response) => {
...
export const LoginUser = createAsyncThunk(
  ...
  async (user) => {
    ...
    const response = await axios.post('https://any-blogs.vercel.app/api/login', { username, password })
      .then((response) => {
...
export const UserProfile = createAsyncThunk(
  ...
  async () => {
    ...
    const response = await axios.post('https://any-blogs.vercel.app/api/getuser', {}, {
      headers: {
...
export const UserProfileEdit = createAsyncThunk(
  ...
  async (user) => {
    ...
    const response = await axios.patch('https://any-blogs.vercel.app/api/user/profile_edit', {
...
export const UserPasswordChange = createAsyncThunk(
  ...
  async (passwordchnage) => {
    ...
    const response = await axios.patch('https://any-blogs.vercel.app/api/user/password/chnage', {
      password
    }, {
      headers: {
        'auth-token': localStorage.getItem('auth-token')
...
export const ContactFeedback = createAsyncThunk(
  ...
  async (contatc) => {
    ...
    const response = await axios.post('https://any-blogs.vercel.app/api/user/feeback', {
      feedback
    }, {
      headers: {
        'auth-token': localStorage.getItem('auth-token')
